...
const Card = ({ pet, onAdoptionClick }: { pet: Pet, onAdoptionClick: (id: number) => void; }) => {
  const handleClick = () => {
    onAdoptionClick(pet.id ?? 0);
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between w-full px-1">
        <div>
          <p className="font-bold">
            Espécie: <span className="font-normal">{pet.especie}</span>
          </p>
          <p className="font-bold">
            Sexo: <span className="font-normal">{pet.sexo}</span>
          </p>
        </div>
        <div>
          <p className="font-bold">
            Raça: <span className="font-normal">{pet.raca}</span>
          </p>
          <p className="font-bold">
            Porte: <span className="font-normal">{pet.tamanho}</span>
          </p>
        </div>
      </div>
      <div className="w-full px-1">
        <p className="font-bold">
          Data de nascimento:{" "}
          <span className="font-normal">{dataNascimento}</span>
        </p>
        <p className="font-bold">
          Personalidade:{" "}
          <span className="font-normal">{pet.personalidade}</span>
        </p>
        <p className="font-bold">
          Descrição: <span className="font-normal">{pet.descricao}</span>
        </p>
      </div>
